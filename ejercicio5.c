/*Ejercicio 5: Suma, resta, division, modulo o multiplicacion y segun la opcion seleccionada se realice la operacion solicitando previamente los numeros al usuario por teclado.*/
#include <stdio.h>
...
int main() {
    ...
    printf("Para operar con una multiplicacion usa: x o *\n");//Al usuario le damos dos opciones para multiplicar, debido que podria usar cualquiera de las dos aniadidas y si no estuviera implementado en el cidgo saldria como error.
    ...
    switch (tipo_de_operacion) { //Aqui usamos la estructura "switch" para considerar decisiones de varias posibilidades, entre ellas el tipo de operacion que haya elegido el usuario. De esta forma no se requiere de un ciclo de "if" o "else" para reducir tamanio y simplificarlo.
